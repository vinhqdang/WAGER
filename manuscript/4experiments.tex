...
alignment channel is indistinguishable from zero: $\widehat{\Delta R}=-0.00006$ with a
$95\%$ interval of $[-0.00120,+0.00109]$ and a randomization $p$ of $.555$. Essentially
the entire proper-score difference, $-0.18258$ of $-0.18264$, is prior-transported.
...
excludes zero. The two proper scores therefore disagree on whether any real alignment
...
alignment estimate). We do not adjudicate between the two scores here: nothing in
Section~\ref{sec:setup} privileges one proper score's alignment estimate as the
...
overwhelmingly prior-transported, with an instance-alignment remainder that is at most
a small fraction of the total and may be exactly zero --- not the stronger, single-score
claim that instance alignment is unchanged.
...
of rare predicates, is compatible with an instance-alignment change that is either zero
