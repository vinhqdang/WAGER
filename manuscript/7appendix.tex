...
afterwards, which removes roughly a third of the encoder work without changing any
feature. Only the images referenced by the audited relations are retrieved, individually
rather than through the two bulk archives.
